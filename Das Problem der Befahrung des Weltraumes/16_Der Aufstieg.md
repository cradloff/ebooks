...
annähernd lotrech ter Richtung. Dabei nimmt zunächst die Steiggeschwindigkeit
...
<tr>
  <td>η<span class="sub">rm</span> = (v' / c)² / (e<span>v'/c</span>- 1)</td>
...
<tr><td>1,59	</td><td>0,65	</td><td>65</td></tr>
...
Daraus folgt mit M<span class="sub">0</span> = Me<span>v'/c</span> (siehe folgende Seite 49):
 η<span class="sub">rm</span> = (Mv'²) / (Me<span>v'/c</span> - M)c²
 = (v' / c)² / (e<span>v'/c</span>- 1)</div>
