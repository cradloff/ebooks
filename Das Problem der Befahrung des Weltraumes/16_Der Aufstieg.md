...
<p>Abb. 19. Lotrechter Aufstieg — „<em>Steilaufstieg</em>” — einer Raumrakete.</p></div>
...
des Rückstoßes” η<span class="sub">rm</span> in Betracht ziehen. 
...
η<span class="sub">rm</span> = (v' / c)² / (e<span class="super">v'/c</span> - 1)
...
<table id="tabelle4">
	...
	<tr align="center">
		...
		<td colspan="2">Mittlerer Wirkungsgrad des Rückstoßes η<span class="sub">rm</span>
		während der Beschleunigungsperiode</td>
	</tr>
	<tr style="border-top: thin solid; border-bottom: medium double;">
		<td style="border-right: thin solid;">η<span class="sub">rm</span> = (v' / c)² / (e<span class="super">v'/c</span> - 1)</td>
		<td>η<span class="sub">rm</span> in Prozenten</td>
	</tr>
...
<div class="image left"><img alt="Veranschaulichung des Rückstoßes beim Aufstieg" src="abb21.png"/>
<p>Abb. 21. Solange das Fahrzeug während des Aufstieges durch den Antrieb <em>unterstützt</em>
...
<div class="image left"><img alt="Veranschaulichung der Kräfte beim Aufstieg" src="abb22.png"/>
...
<p>Man erkennt deutlich, daß trotz <em>gleichbleibender</em> ideeller Beschleunigung (Stärke
...
<div class="footnote" id="fn1"><a href="#rn1">1</a>Siehe Seite 16.</div>

<div class="footnote" style="white-space: pre-wrap;" id="fn2"><a href="#rn2">2</a>
Der mittlere Wirkungsgrad des Rückstoßes η<span class="sub">rm</span> = Gewonnene Energie / Aufgewendete Energie
 = Lebendige Kraft der Endmasse M bei der Endgeschwindigkeit v' / Lebendige Kraft der Abstoßungsmasse (M<span class="sub">0</span> - M) bei der Abstoßungsgeschwindigkeit c
 also: η<span class="sub">rm</span> = (Mv'²/2) / ((M<span class="sub">0</span> - M) c² / 2)

Daraus folgt mit M<span class="sub">0</span> = Me<span class="super">v'/c</span> (siehe folgende Seite 49):
 η<span class="sub">rm</span> = (Mv'²) / (Me<span class="super">v'/c</span> - M)c²
 = (v' / c)² / (e<span class="super">v'/c</span> - 1)</div>
